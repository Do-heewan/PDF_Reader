...
PDF로 된 개발 서적을 **챕터별로 분할**하고, 각 챕터를 읽어 **한국어 학습노트(`.md`)**로
정리해 주는 로컬 도구입니다.

> 만든 목적: 쿠버네티스 원서(약 350쪽, 30챕터)를 **하루 1챕터씩 한 달간** 학습하고,
> 그 내용을 개발 블로그에 정리·업로드하기 위해서.
